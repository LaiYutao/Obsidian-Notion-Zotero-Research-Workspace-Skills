#!/usr/bin/env python3
"""Compact search and preview helper for the LLM Wiki vault."""
...
def frontmatter(text: str, max_lines: int = 60) -> str:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Search and preview LLM Wiki Markdown notes with compact output.")
    ...
    search.add_argument("--fixed", action="store_true")
